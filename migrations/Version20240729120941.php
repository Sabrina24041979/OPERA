 ...
 */
final class Version20240729120941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_interview DROP interval_date, CHANGE isAutomatic is_automatic TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_interview ADD interval_date VARCHAR(255) DEFAULT NULL, CHANGE is_automatic isAutomatic TINYINT(1) NOT NULL');
