 ...
 */
final class Version20240304090751 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile ADD CONSTRAINT FK_8157AA0F5D430949 FOREIGN KEY (personal_id) REFERENCES personal (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
